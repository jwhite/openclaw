...
import { definePluginEntry, normalizeAgentId } from "./api.js";
import { resolveHaVoicePluginConfig } from "./src/config.js";
import { createHaVoiceWebhookRequestHandler } from "./src/http.js";
function registerHaVoiceRoute(api) {
...
export default definePluginEntry({
    ...
    description: "Authenticated webhook bridging a Home Assistant Assist pipeline to a real OpenClaw agent.",
    register(api) {
