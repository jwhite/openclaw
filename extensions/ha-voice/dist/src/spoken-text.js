...
export const SPOKEN_OUTPUT_CONTRACT = [
    ...
    '- One exception: if you started or resumed audio playback, return {"spoken":""}. The audio is',
    "  its own confirmation, and it is already playing by the time you would be heard, so anything",
    "  spoken lands on top of it. Speak only if playback failed, or if the user asked a question as",
    "  well as asking for music.",
